...
class Req_worker():
    ...
    def _batching(self):
        ...
        self.partialdata = sorted(self.partialdata, key=lambda x: x.count(' '))
...
class InferenceRequest():
    ...
    def inference_run(self): 
        ...
        with ThreadPoolExecutor(max_workers=len(self.devs)) as ex:
            ...
            concurrent.futures.wait(workerqueue, return_when="FIRST_EXCEPTION")
...
class Session():
    ...
    def session_run(self):
        with ThreadPoolExecutor() as ex:
            ...
            concurrent.futures.wait(output_rq, return_when="FIRST_EXCEPTION")
        output_embeddings = list(i.result() for i in output_rq)
